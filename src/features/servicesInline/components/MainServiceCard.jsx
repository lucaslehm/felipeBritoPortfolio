...
function MainServiceCard({ icon, serviceName, description }) {
  const IconComponent = RemixIcons[icon];

  return (
    <div className="flex flex-col gap-4 ring-3 ring-[#461901] shadow-[5px_5px_0px_#461901] p-5 w-[210px] cursor-pointer transition-all hover:scale-102 hover:bg-orange-100">
